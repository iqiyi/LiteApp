...
var inWeb = typeof window !== 'undefined';
...
function addDirect(
  ...
  if(!patchData[("direct_" + type)]){
    ...
    patchData[("direct_" + type)].push({ op: op , val : filteredNode });
  }
}
...
var api = Object.freeze({
	webviewCall: webviewCall
});

/*  */
function webviewCall$1(
  _uid ,
  fnName  , 
  params 
){
...
var eventKeep = new Object();
var baseEventKeep = new Object();
...
function triggerBaseEvent( eventObj ) {
    var handlers;
...
var event = Object.freeze({
	saveEvent: saveEvent,
	saveBaseEvent: saveBaseEvent,
	removeEvent: removeEvent,
	removeBaseEvent: removeBaseEvent,
	triggerEvent: triggerEvent,
	triggerBaseEvent: triggerBaseEvent,
	default: eventKeep
});
...
var bridge = new Object({
  ...
  doPatch : function () {
    ...
    if( inApp ){
      var patchJson = JSON.stringify(bridgePatch.patchData);
    ...
    if( inWeb ){
      ...
      if(typeof window.__bridge__ === 'undefined'){
        ...
        window.__bridge__.on_recv_patch_command(bridgePatch.patchData);
      }
    }        
    bridgePatch.clear();
  },
  ...
  getBaseEvent : function (eventObj)  {
    typeof console !== 'undefined' && console.log(eventObj);
    triggerBaseEvent( eventObj );
  }
});
...
function setAttr( qnode , key , value ){
...
function setStyle( qnode , style ){
    addDirect( 'attr' , 'setStyle' , {
        _uid : qnode._uid,
        style : style
    });
}
function addEvent( qnode , event , handler ){
...
function removeEvent$1( qnode , event , handler , capture , passive ){
    
    removeEvent$1( qnode._uid , event );
...
function setTextContent$1( qnode , text ){
...
var QNode = function QNode( tagName  , vnode  ) {
    this._uid = qnode_uid++ ;
...
QNode.prototype.setStyle = function setStyle$1 (){
    if(this.style){
        setStyle(this,this.style);
    }
};
QNode.prototype.hasAttribute = function hasAttribute ( key  ) {
    return !!this.attrs[key];
};
QNode.prototype.setAttribute = function setAttribute ( key  , value  ) {
    setAttr(this,key,value);
};
QNode.prototype.removeAttribute = function removeAttribute ( key  ){
    removeAttr( key );
};
QNode.prototype.addEventListener = function addEventListener (
    event ,
    handler ,
    capture ,
    passive 
...
QNode.prototype.removeEventListener = function removeEventListener (
    event ,
    handler ,
    capture 
){
    removeEvent$1( this , event , capture );
};

var Style = function Style(){

};
Style.prototype.setProperty = function setProperty (name,value,type){
    this[name] = value;
};
...
function createElementNS (namespace, tagName) {
  return new QNode(tagName,{ns : namespaceMap$1[namespace]});
}
...
function insertBefore (parentNode, newNode, referenceNode) {
  ...
  if(referenceNode){
    ...
    var referIndex = parentNode.children.indexOf(referenceNode);
  ...
  // add direct
  insertBefore$1( parentNode , newNode , referenceNode );
}
...
function createNative( nativeCom  ){
  // judge nativeCom here
  
  addDirect( 'native' , 'createNative' , nativeCom);
}

function removeNative( nativeCom  ){
  // judge nativeCom here
...
var QyNativeBase = {
  ...
  mounted : function(){
    ...
    this.$watch('nativeData',function (){
      removeNative({
        _uid : this$1._vnode.elm._uid
      });
      createNative({
        _uid : this$1._vnode.elm._uid,
        nativeTag : this$1.nativeTag,
        hover : isDef(this$1.hover) ? true : false,
        data : this$1.nativeData || {}
      });
    });
  },
  destroyed : function(){
...
// regist update patch
var _update = Vue$3.prototype._update;
Vue$3.prototype._update = function (vnode, hydrating) {
...
/* if inApp */
Vue$3.prototype.$nativeOn = function (
  event,
  fn
) {
    var vm = this;
...
Vue$3.prototype.$webviewCall = function(
  fnName  , 
  params 
) {
  var vm = this;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_listblock_vue__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_4f7b2a7a_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_listblock_vue__ = __webpack_require__(14);
var disposed = false
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_QYSwipedGroup_vue__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_35c1b7ce_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_QYSwipedGroup_vue__ = __webpack_require__(8);
var disposed = false
var normalizeComponent = __webpack_require__(0)
/* script */
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_QYSwipedGroup_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_35c1b7ce_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_QYSwipedGroup_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src/webview/QYSwipedGroup.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {  return key !== "default" && key.substr(0, 2) !== "__"})) {  console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-35c1b7ce", Component.options)
  } else {
    hotAPI.reload("data-v-35c1b7ce", Component.options)
' + '  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["a"] = ({
  name: 'qy-swiped-group',
  updated: function updated() {
    this.$webviewCall('swipeToDelete');
  }
});
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "qy-swiped-group" }, [_vm._t("default")], 2)
}
var staticRenderFns = []
render._withStripped = true
var esExports = { render: render, staticRenderFns: staticRenderFns }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-35c1b7ce", esExports)
  }
}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_listview_vue__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_ba1f7b70_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_listview_vue__ = __webpack_require__(15);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_QYScrollView_vue__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_2e30b509_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_QYScrollView_vue__ = __webpack_require__(19);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_QYSwiper_vue__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_42bbdaef_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_QYSwiper_vue__ = __webpack_require__(23);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_QYSwiper_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_42bbdaef_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_QYSwiper_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src/webview/QYSwiper.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {  return key !== "default" && key.substr(0, 2) !== "__"})) {  console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-42bbdaef", Component.options)
  } else {
    hotAPI.reload("data-v-42bbdaef", Component.options)
' + '  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "qy-swiper" }, [
    _c("div", { staticClass: "qy-swiper-wrap" }, [_vm._t("default")], 2)
  ])
}
var staticRenderFns = []
render._withStripped = true
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-42bbdaef", esExports)
  }
}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_QYSwiperItem_vue__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_2ad815bc_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_QYSwiperItem_vue__ = __webpack_require__(26);
var disposed = false
var normalizeComponent = __webpack_require__(0)
/* script */
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_QYSwiperItem_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_2ad815bc_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_QYSwiperItem_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src/webview/QYSwiperItem.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {  return key !== "default" && key.substr(0, 2) !== "__"})) {  console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2ad815bc", Component.options)
  } else {
    hotAPI.reload("data-v-2ad815bc", Component.options)
' + '  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "qy-swiper-item" }, [_vm._t("default")], 2)
}
var staticRenderFns = []
render._withStripped = true
var esExports = { render: render, staticRenderFns: staticRenderFns }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-2ad815bc", esExports)
  }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__native_QYInput_vue__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__native_QYVideo_vue__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__native_QYNavigator_vue__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__native_QYPullToRefresh_vue__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__webview_QYActionSheet_vue__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__webview_QYSwiped_vue__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__webview_QYSwipedGroup_vue__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__webview_QYListView_listview_vue__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__webview_QYListView_listblock_vue__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__webview_QYScrollView_vue__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__webview_QYSwiper_vue__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__webview_QYSwiperItem_vue__ = __webpack_require__(24);
...
Vue.component('qy-swiped', __WEBPACK_IMPORTED_MODULE_6__webview_QYSwiped_vue__["a" /* default */]);
Vue.component('qy-swipedgroup', __WEBPACK_IMPORTED_MODULE_7__webview_QYSwipedGroup_vue__["a" /* default */]);
Vue.component('qy-listview', __WEBPACK_IMPORTED_MODULE_8__webview_QYListView_listview_vue__["a" /* default */]);
Vue.component('qy-listblock', __WEBPACK_IMPORTED_MODULE_9__webview_QYListView_listblock_vue__["a" /* default */]);
...
Vue.component('qy-scrollview', __WEBPACK_IMPORTED_MODULE_10__webview_QYScrollView_vue__["a" /* default */]);
Vue.component('qy-navigator', __WEBPACK_IMPORTED_MODULE_3__native_QYNavigator_vue__["a" /* default */]);
Vue.component('qy-pulltorefresh', __WEBPACK_IMPORTED_MODULE_4__native_QYPullToRefresh_vue__["a" /* default */]);
Vue.component('qy-actionsheet', __WEBPACK_IMPORTED_MODULE_5__webview_QYActionSheet_vue__["a" /* default */]);
Vue.component('qy-swiper', __WEBPACK_IMPORTED_MODULE_11__webview_QYSwiper_vue__["a" /* default */]);
Vue.component('qy-swiper-item', __WEBPACK_IMPORTED_MODULE_12__webview_QYSwiperItem_vue__["a" /* default */]);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_QYInput_vue__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_13c4eba3_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_QYInput_vue__ = __webpack_require__(36);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  mounted: function mounted() {
    ...
    this.$nativeOn('bindinput', function (params) {
      _this.$emit('change', params);
      console.log('[qy-input] params : ' + params);
    });
    this.$nativeOn('bindconfirm', function (params) {
...
var render = function() {
  ...
  return _c("qy-native-base", {
    attrs: {
      hover: _vm.hover,
      nativeData: _vm.nativeData,
      nativeTag: "QiyiInput"
    },
    on: { bindinput: function($event) {} }
  })
}
var staticRenderFns = []
render._withStripped = true
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_QYVideo_vue__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_050c3058_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_QYVideo_vue__ = __webpack_require__(40);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_QYNavigator_vue__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_e028b1a0_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_QYNavigator_vue__ = __webpack_require__(43);
var disposed = false
var normalizeComponent = __webpack_require__(0)
/* script */
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_QYNavigator_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_e028b1a0_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_QYNavigator_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src/native/QYNavigator.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {  return key !== "default" && key.substr(0, 2) !== "__"})) {  console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-e028b1a0", Component.options)
  } else {
    hotAPI.reload("data-v-e028b1a0", Component.options)
' + '  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["a"] = ({
  props: ['isShowTitle', 'text', 'color', 'logoPath', 'isShowIndicator', 'mode', 'MenuList'],
  mounted: function mounted() {
    __api__.baseCall('setTitle', this.$options.propsData);
  }
});
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "qy-navigator" })
}
var staticRenderFns = []
render._withStripped = true
var esExports = { render: render, staticRenderFns: staticRenderFns }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-e028b1a0", esExports)
  }
}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_QYPullToRefresh_vue__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_81e76518_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_QYPullToRefresh_vue__ = __webpack_require__(46);
var disposed = false
var normalizeComponent = __webpack_require__(0)
/* script */
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_QYPullToRefresh_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_81e76518_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_QYPullToRefresh_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src/native/QYPullToRefresh.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {  return key !== "default" && key.substr(0, 2) !== "__"})) {  console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-81e76518", Component.options)
  } else {
    hotAPI.reload("data-v-81e76518", Component.options)
' + '  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["a"] = ({
  props: ['enabled', 'color', 'background'],
  mounted: function mounted() {
    __api__.baseCall('setSwipeRefresh', this.$options.propsData);
  }
});
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-81e76518", esExports)
  }
}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_QYActionSheet_vue__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_5ce99e62_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_QYActionSheet_vue__ = __webpack_require__(50);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_QYActionSheet_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_5ce99e62_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_QYActionSheet_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src/webview/QYActionSheet.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {  return key !== "default" && key.substr(0, 2) !== "__"})) {  console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5ce99e62", Component.options)
  } else {
    hotAPI.reload("data-v-5ce99e62", Component.options)
' + '  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "mp-actionsheet" }, [
    _c("div", { staticClass: "fade-in" }),
    _vm._v(" "),
    _c("div", { staticClass: "slide-up" }, [
      _c(
        "div",
        { staticClass: "menu" },
        _vm._l(_vm.menu, function(item, index) {
          return _c(
            "div",
            { staticClass: "cell", on: { tap: item.callback } },
      ...
      _c(
        "div",
        { staticClass: "action" },
        _vm._l(_vm.action, function(item, index) {
          return _c(
            "div",
            { staticClass: "cell", on: { tap: item.callback } },
            [_vm._v(_vm._s(item.label))]
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-5ce99e62", esExports)
  }
}
