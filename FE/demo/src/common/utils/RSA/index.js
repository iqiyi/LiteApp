...
(function(obj) {
     ...
     */
    if (typeof obj.RSAUtils === 'undefined') {
        RSAUtils = obj.RSAUtils = {};
    }
    ...
    var BigInt = obj.BigInt = function(flag) {
    ...
    var RSAKeyPair = function(encryptionExponent, decryptionExponent, modulus) {
        ...
        this.radix = 16;
        this.barrett = new obj.BarrettMu(this.m);
    };
    ...
    if (typeof obj.twoDigit === 'undefined') {
        obj.twoDigit = function(n) {
