...
const builds = {
  ...
  'qy-full-dev': {
    ...
    dest: resolve('dist/qy/qy.thread.js'),
    format: 'umd',
    env: 'development',
    alias: { he: './entity-decoder' },
    banner
  ...
  'qy-full-prod': {
    entry: resolve('qy/entry-runtime-with-compiler.js'),
    dest: resolve('dist/qy/qy.thread.min.js'),
    format: 'umd',
    env: 'production',
    alias: { he: './entity-decoder' },
    banner
  ...
  'qy-webview-dev': {
    ...
    dest: resolve('dist/qy/qy.webview.js'),
    format: 'umd',
    env: 'development',
    alias: { he: './entity-decoder' },
    banner
  ...
  'qy-webview-prod': {
    entry: resolve('qy/webview/webview.js'),
    dest: resolve('dist/qy/qy.webview.min.js'),
    format: 'umd',
    env: 'production',
    alias: { he: './entity-decoder' },
    banner
...
if (process.env.TARGET) {
  ...
  exports.getAllBuilds = () => ['qy-full-prod','qy-webview-prod'].map(genConfig)
}
