...
@interface QIYIBusinessModel : NSObject
@property (nonatomic, strong, readwrite) NSString *version;
@property (nonatomic, strong, readwrite) NSString *base_version;
@property (nonatomic, strong, readwrite) NSString *manifest_url;
