...
var QyNativeBase = {
  ...
  render : function( _c ){
    return _c('div',{class:'qy-native-component',attrs:{data:JSON.stringify(this.data)}});
  },
  updated : function(){
...
/* if inApp */
Vue$3.prototype.$nativeOn = function (event, fn) {
    var vm = this;
    if (Array.isArray(event)) {
        for (var i = 0, l = event.length; i < l; i++) {
...
Vue$3.prototype.$webviewCall = function(
  ...
  var vm = this;
  webviewCall(vm._vnode.elm._uid,fnName , params);
  return vm;
};
